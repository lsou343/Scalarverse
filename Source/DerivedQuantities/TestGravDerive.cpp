                         ...
                         amrex::Real time, const int* bcrec, int level)
{
    ...
    amrex::ParallelFor(bx, [=] AMREX_GPU_DEVICE(int i, int j, int k) noexcept {
        der(i, j, k, dcomp) = dat(i, j, k, AxTestGrav::getField(AxTestGrav::Fields::PhiGrav));
    });
}
                         ...
                         amrex::Real time, const int* bcrec, int level)
{
    ...
    amrex::ParallelFor(bx, [=] AMREX_GPU_DEVICE(int i, int j, int k) noexcept {
        der(i, j, k, dcomp)     = (dat(i + 1, j, k, AxTestGrav::getField(AxTestGrav::Fields::PhiGrav)) -
                                    dat(i - 1, j, k, AxTestGrav::getField(AxTestGrav::Fields::PhiGrav))) / (2.0 * dx);
        der(i, j, k, dcomp + 1) = (dat(i, j + 1, k, AxTestGrav::getField(AxTestGrav::Fields::PhiGrav)) -
                                    dat(i, j - 1, k, AxTestGrav::getField(AxTestGrav::Fields::PhiGrav))) / (2.0 * dx);
        der(i, j, k, dcomp + 2) = (dat(i, j, k + 1, AxTestGrav::getField(AxTestGrav::Fields::PhiGrav)) -
                                    dat(i, j, k - 1, AxTestGrav::getField(AxTestGrav::Fields::PhiGrav))) / (2.0 * dx);
    });
}
